...
[Demo on YouTube](http://www.youtube.com/watch?v=qlq3n5r1Xy0)
...
The source code is written in C++ and I'm using OpenCV for image processing together with VTK for displaying the 3D mesh.

![Screenshot Export](https://raw2.github.com/NewProggie/Uncalibrated-Photometric-Stereo/master/images/export.png)
